...
urlpatterns = [
    ...
    path('superadmin/company/<int:company_id>/test-connection/', views.company_test_connection, name='company_test_connection'),
    path('superadmin/company/test-connection/', views.company_test_connection, name='company_test_connection_new'),
